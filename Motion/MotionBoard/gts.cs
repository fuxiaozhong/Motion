...
namespace GTN
{
    public class mc
    {
        ...
        [DllImport("gts.dll")]
        public static extern short GT_GetGLinkDo(short slaveno, ushort offset, ref uint pData, ushort bytelength);
        [DllImport("gts.dll")]
        public static extern short GT_GetGLinkDi(short slaveno, ushort offset, out uint pData, ushort bytelength);
        [DllImport("gts.dll")]
